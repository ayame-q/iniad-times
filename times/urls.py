...
urlpatterns = [
    ...
    path('staff/reedit/', views.ReeditArticleListView.as_view(), name="reedit-list"),
    path('staff/reedit/<int:pk>', views.ReeditArticleView.as_view(), name="reedit"),
    path('staff/reedit/<uuid:uuid>', views.ReeditArticleView.as_view(), name="reedit"),
