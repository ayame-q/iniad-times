...
SECRET_KEY = os.environ["DJANGO_SECRET_KEY"] if os.environ.get("DJANGO_SECRET_KEY") else 'rw5c7!j48w6e1r+pkb&hf4)8xy_#uyzdg4xk*1zufyp#tmi5*!'
...
MIDDLEWARE = [
    "times.middleware.auth.StaffOnlyMiddleware",
